...
<head>
    ...
    <script src="https://libel.work/pi/assets/exporting.js"></script>
    ...
    <link rel="shortcut icon" href="./assets/pi.ico" />
</head>
<body>
<div id="app">
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="https://libel.work">Pi Dashboard</a>
            </div>
                        ...
                        for($i = 0; $i<$D['net']['count'];$i++)
                        {
                            ...
                            <div class="row" style="margin: 0;">
                                <div class="col-md-10 col-sm-10 col-xs-10" style="padding: 0;">
                                    <div id="container-net-interface-<?php echo($i+1) ?>" style="min-width: 100%; height: 150px;"></div>
                                </div>
                                <div class="col-md-2 col-sm-2 col-xs-2" style="padding: 0;">
...
<script src="https://libel.work/pi/assets/dashboard.min.js"></script>
</body>
</html>
