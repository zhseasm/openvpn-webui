...
<br>
			...
			<br><div class="col-md-12 text-center">
				...
				if ($success)
				{
					...
					echo'<a class="btn btn-primary btn-lg" style="margin-left: 6px !IMPORTANT;" href="/admin/vpnconfig/restore?confname='.basename( $_FILES["fileToUpload"]["name"]).'" role="button">Apply</a></p>';
				}
